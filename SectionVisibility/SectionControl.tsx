 ...
 */
    ...
    return(
        <div style={{color:color, borderBottom:'1px solid', borderColor:'rgb(237,235,233)',fontFamily:'SegoeUI-Semibold',display:'flex',justifyContent:"flex-start",alignItems:"center",boxSizing:"border-box"}} tabIndex={0} ref={controlRef} onClick={()=>setControlValue(!controlValue)} id={`${context?.parameters.controllerValue.attributes?.LogicalName}_pcf_control`} aria-label={userLang === 1036? frLabel : engLabel} onKeyUp={handleAccessibilityKeyupEvent}>
            {
                controlValue?
